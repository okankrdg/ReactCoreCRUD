    ...
    <div className="employeeForm col-md-8">
      ...
      <div className="col-md-6">
        ...
        <input
          type="email"
          className={`form-control ${
            employeeValidation.email ? "is-valid" : "is-invalid"
          }`}
      ...
      <div className="col-md-6">
        ...
        <select
          id="inputState"
          className={`form-control ${
            employeeValidation.employeeTypeId ? "is-valid" : "is-invalid"
          }`}
        ...
        {employeeValidation.email ? (
          ...
          <div className="invalid-feedback">Lütfen pozisyon tipi seçiniz</div>
        )}
      </div>
