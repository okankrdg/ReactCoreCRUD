...
const CreateOrEdit = () => {
  ...
  const setValid = () => {
    ...
    if (employee.email === "" || employee.email == null || employee.email.) {
  ...
  const  isValidForm = () => {
    return employeeValidation.firstName && employeeValidation.lastName && employee.email && employee.employeeTypeId
  }
  useEffect(() => {
